...
export function ToolOutput({ name, data }: ToolOutputProps) {
	return (
		<details className="my-2">
			...
			<pre className="mt-2 p-2 bg-zinc-100 dark:bg-zinc-800 rounded text-xs overflow-auto border border-zinc-200 dark:border-zinc-700 text-zinc-800 dark:text-zinc-200">
